export default {
  ...
  about: "About",
  aboutText1:
    "Hello there! My name is José García. I am a fullstack web developer. I enjoy making ideas happen on the web using current development technologies. I build clean, well-designed and user-friendly (with SEO in mind) sites and apps.",
  aboutText2:
  ...
  aboutText3:
    "My clients range from one person micro businesses to large companies like Dt4o . Let's discuss your needs and goals so I can provide you with a plan that will get you the results you want.",
  myPictureAlt: "My personal picture",
  intuitive: "Intuitive",
  intuitiveText: "User experience focused web sites",
  fast: "Fast",
  fastText: "The site's performance is a priority",
  responsive: "Responsive",
  responsiveText: "Web sites that work and look good in different screens",
  reactive: "Reactive",
  reactiveText: "Instant reactions to the user's interactions",
  skills: "Skills",
  contacts: "Contacts",
  ...
  projects: {
    ...
    description: {
      queues:
        "This project is about taking tickets to for virtual queues. It aims to eliminate physical queues.",
      "johnson-turbine":
      ...
      kanpeki:
        "Santiaguero project that covers Asian and Western pop culture (includes Japanese, Korean, Chinese pop and traditional culture, etc.; in addition to video games, comics, literature in general, cinephilia and world-class music).",
      sanchoRestaurant:
  ...
  database: "Database",
  databaseDescription: "They way you save data.",
